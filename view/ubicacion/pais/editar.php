...
<div class="container-fluid jumbotron">
    <center><h1 class="page-header">ACTUALIZAR PA&Iacute;S</h1></center>
</div>
    <?php  
...
<div class="container-fluid">
    <form method="post" action="<?php echo getUrl("Ubicacion/Pais", "Pais", "postEditar") ?>">
            ...
            <div class="col-md-5 form-group center-block">
                ...
                <input class="form-control" name="pai_descripcion" value="<?php echo $pai['pai_descripcion']; ?>">
            </div><br><br><br><br><br>
