...
<div class="container-fluid jumbotron">
    <center><h1 class="page-header">ELIMINAR CIUDAD</h1></center>
</div>
    <?php  
...
<div class="container-fluid">
    <form method="post" action="<?php echo getUrl("Ubicacion/ciudad", "ciudad", "postEliminar") ?>">
            ...
            <div class="col-md-5 form-group center-block">
                ...
                <input class="form-control" readonly name="ciu_descripcion" value="<?php echo $ciu['ciu_descripcion']; ?>">
            </div>
            <div class="col-md-5 form-group center-block">
        ...
        <center>
            <div class="col-md-10"><br>
                ...
                <a href="<?php echo getUrl("Ubicacion/ciudad", "ciudad", "listar"); ?>" class="btn btn-danger btn-lg" type="button">Cancelar</a>
            </div>
        </center>
</form>
</div>
